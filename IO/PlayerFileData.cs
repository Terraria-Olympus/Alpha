...
namespace Alpha.IO
{
    ...
    {
        public string Name;
        public int[] CreativeSacrifices = new int[ItemID.Count];
        ...
        public static PlayerFileData Load(string path)
        {
            ...
            using CryptoStream cryptoStream =
                new(stream, rijndael.CreateDecryptor(TerrariaConstants.PlayerEncryptionKey, TerrariaConstants.PlayerEncryptionKey), CryptoStreamMode.Read);
            ...
            if (fileVersion >= 218)
                LoadCreativeSacrifices(ref ret.CreativeSacrifices, reader);
        ...
        public static void LoadCreativeSacrifices(ref int[] creativeSacrifices, BinaryReader reader)
        {
            ...
            for (int i = 0; i < amount; i++)
            {
                ...
                int researchAmount = reader.ReadInt32();
                creativeSacrifices[ItemID.Search.GetId(name)] = researchAmount;
            }
        }
